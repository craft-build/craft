...
The `model` value is a `provider/model-id` spec, same format as `craft --model`.
...
Authentication, providers, and permissions come from your normal Craft config. Set up [providers](/docs/providers/) first and ACP sessions just work.
