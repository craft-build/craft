...
- Supported languages: Rust, TypeScript/JavaScript, Python, Go, Java, C, C++, Ruby, Lua, Bash, Kotlin, Swift, C#, Elixir, Scala, PHP, HTML, Gleam, Dart, Starlark/Bazel, Nix, Zig, Markdown, YAML.
