...
mod tests {
    ...
    #[tokio::test]
    async fn callback_receives_code_on_custom_path() {
    ...
    #[tokio::test]
    async fn bind_pins_requested_port() {
    ...
    #[tokio::test]
    async fn bind_advertises_custom_hostname() {
    ...
    #[tokio::test]
    async fn bind_defaults_to_stock_path() {
        let server = CallbackServer::bind(None, None, None).await.unwrap();
        assert_eq!(
            server.redirect_uri(),
    ...
    #[tokio::test]
    async fn bind_pinned_port_in_use_is_error() {
