//! `craft.image`: image primitives for plugins. Neovim has no image API to
...
//! `(nil, err)` convention of `craft.fs`.
    ...
    fn add_methods<M: UserDataMethods<Self>>(methods: &mut M) {
        ...
        methods.add_async_method("resize", |_, this, (max_w, max_h): (u32, u32)| {
            ...
            async move {
                ...
                .await
                .map_err(|e| mlua::Error::runtime(format!("resize: {e}")))?;
        ...
        methods.add_async_method("encode", |lua, this, format: String| {
            ...
            async move {
                ...
                .await
                .map_err(|e| mlua::Error::runtime(format!("encode: join: {e}")))?
