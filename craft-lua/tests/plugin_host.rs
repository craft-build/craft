...
#[test_case::test_case(
    r#"craft.api.register_command({ name = "/test", max_args = -2, handler = function() end })"#,
    "non-negative or -1" ; "negative_max_args"
)]
#[test_case::test_case(
    r#"craft.api.register_command({ name = "/test", max_args = "one", handler = function() end })"#,
    "must be an integer" ; "string_max_args"
)]
#[test_case::test_case(
    r#"craft.api.register_command({ name = "/test", max_args = math.huge, handler = function() end })"#,
