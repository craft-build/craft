//! Advisory locks between craft processes.
//!
//! Several craft processes share one checkout directory, one lockfile, and one
...
pub enum LockError {
    #[error("{path} is locked by another Craft process")]
    Held { path: PathBuf },
