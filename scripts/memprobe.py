#!/usr/bin/env python3
"""Measure craft's resident memory under a real session, honestly.

Two mistakes make craft memory numbers wrong, and both have burned us:
...
Usage:
    scripts/memprobe.py -s <session-id> -n 5 ./base/craft ./target/debug/craft
"""
