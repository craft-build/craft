//! Rolling user-input history for the prompt line, capped at 100 entries.
//!
//! Ported from the reference `craft-storage/src/input_history.rs`.
...
impl InputHistory {
    ...
    pub fn save(&self, dir: &StateDir) -> StorageResult<()> {
