//! Persisted model selection and the recent-models list (max 4, most recent
//! first).
//!
//! Ported from the reference `craft-storage/src/model.rs`.
...
pub fn persist_model(dir: &StateDir, spec: &str) -> StorageResult<()> {
