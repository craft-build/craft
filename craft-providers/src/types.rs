...
pub mod dialect {
    ...
    use craft_storage::sessions::Effort::{High, Low, Max, Medium, Minimal, XHigh};
...
mod tests {
    ...
    #[test_case(Some(Support::Required), ThinkingConfig::Off,      ThinkingConfig::Effort(Effort::Minimal) ; "required_raises_off_to_minimal")]
