...
#[cfg(test)]
use craft_providers::ModelPricing;
...
#[cfg(test)]
pub(crate) fn test_model() -> craft_providers::Model {
    craft_providers::Model {
        id: "test-model".into(),
        provider: craft_providers::provider::ProviderKind::Anthropic,
        dynamic_slug: None,
