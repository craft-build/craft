...
use craft_config::ClockFormat;
use craft_providers::{Model, ModelUsageRow, ProviderUsage, TokenUsage, format_tokens, model_cost};
...
pub struct UsageModalContext<'a> {
    ...
    /// What the session billed, from [`craft_providers::settle_session`]. `None`
...
mod tests {
    ...
    use craft_providers::UsageLimit;
    ...
    fn modal_rows(
        ...
        line_texts(&build_lines(&ctx, None, &theme))
    }
